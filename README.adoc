...
[source]
----
git clone https://github.com/soapboxjoe/vertx-gradle-starter.git PROJECT_NAME
----
...
* a _main_ verticle file (src/main/groovy/io/vertx/starter/MainVerticle.groovy)
* a unit test (src/main/test/groovy/io/vertx/starter/MainVerticleTest.groovy)
